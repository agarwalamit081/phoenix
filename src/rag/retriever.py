...
class VectorRetriever:
    ...
    def __init__(
        ...
        """
        # Note: If embedding_service is None, a default instance will be created
        # without session (for initialization purposes). When used in context
        # with a real session, provide the service explicitly.
