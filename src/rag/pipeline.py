...
- Provide specific, actionable recommendations when possible"""
    ...
    async def _generate_fallback_response(
        ...
        """
        fallback_prompts = [
            "I don't have specific information about that in my current context. ",
            "Based on general travel knowledge, ",
            "While I don't have detailed information about this specific query, ",
        ]
        ...
        try:
            response = await self.llm_service.chat_completion(
                messages=[
                    ...
                    {
                        "role": "user",
                        "content": f"{fallback_prompts[0]} {query}",
                    },
                ],
                temperature=0.7,
                max_tokens=500,
            ...
            return "I apologize, but I need more information to help you with that request. Could you provide more details about what you're looking for?"
