...
class CacheEntry:
    ...
    def is_expired(self) -> bool:
        ...
        Returns:
            True if expired
        """
        # Prefer monotonic clock to avoid wall-clock adjustments affecting expiry.
        return time.monotonic() >= self._expires_at_monotonic or datetime.now(timezone.utc) >= self.expires_at
